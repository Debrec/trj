!!-------------------------------------------------------------------------------
!!--- Change 25-02-05
!! Go back to use of trj_netcdf_w, changes in writing rutine
!!--- Change 23-02-05
!! posible changes
!! in trj_netcdf_w, or maintain the 4d aproch or reuse
!! the previous mechanism and clean unused code.
!!
!---------------------------------------------------------------------------------
